...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "✅ asistan qrupa qoşuldu")
        ...
        if not admin.can_manage_voice_chats:
            ...
            return await user.send_message(chat_id, "✅ asistan onsuzda qrupdadır")
        return await user.send_message(chat_id, "✅ asistan onuzda qrupdadı")
...
async def leave_chat(_, m: Message):
    ...
    try:
        ...
        return await _.send_message(
            chat_id,
            "✅ asistan qrupdan çıxarıldı",
        )
    except UserNotParticipant:
        return await _.send_message(
            chat_id,
            "❌ asistan onsuzda qrupda yoxdur",
        )
