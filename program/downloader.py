...
def song(_, message):
    ...
    try:
        ...
        m.edit("❌ Musiqi tapılmadı. Başqa musiqi adı yazıb yükləyə bilərsiz ❤️")
        print(str(e))
        return
    m.edit("📥 Musiqi yüklənir...")
    try:
        ...
        for i in range(len(dur_arr) - 1, -1, -1):
            ...
            secmul *= 60
        m.edit("📤 Musiqi qrupa göndərilir...")
        message.reply_audio(
            audio_file,
            caption=rep,
            thumb=thumb_name,
...
async def vsong(client, message):
    ...
    try:
        ...
        print(e)
    try:
        msg = await message.reply("📥 **Video serverə yüklənir...**")
